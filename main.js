    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (index in response.data) {
                ...
                $('<div class="infoDiv col-md-8" data-user="' + user_id + '" data-id="' + id + '"><h3><label>'+campground+'</label>  by '+username+'</span></h3><p>'+summary+'</p><p><strong>Date:</strong> ' + date + '</p><p><strong>Category:</strong> ' + category + '</p><p><strong>Rating:</strong> ' + rating + '</p><p><strong>Tips & Tricks:</strong> ' + tips_tricks + '</div>').appendTo(postDiv);
